...
import { locationRevenueData } from "@/config/charts-data";
    ...
    <Card>
      ...
      <CardContent>
        <div className="space-y-3 sm:space-y-4">
          <div className="w-full rounded-lg flex items-center justify-center relative overflow-hidden px-2 sm:px-4">
