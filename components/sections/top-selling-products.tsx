            ...
            <tbody>
              {products.map((product, index) => (
                <tr key={index} className="border-b border-gray-100 dark:border-gray-700 last:border-0">
                  ...
                  <td className="py-3 px-4 text-sm text-gray-600 dark:text-gray-400">{product.price}</td>
                  <td className="py-3 px-4 text-sm text-gray-600 dark:text-gray-400">{product.quantity}</td>
                  <td className="py-3 px-4 text-sm font-medium text-gray-900 dark:text-gray-100">{product.amount}</td>
                </tr>
              ))}
            </tbody>
          </table>
